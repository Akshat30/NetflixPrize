...
public class NetflixTester {
	...
	public static final String baseFile = "testingDatasets" + FileIO.fileSep + "6Ratings.csv";
	public static final String testFile = "testingDatasets" + FileIO.fileSep + "6Tests.csv";
